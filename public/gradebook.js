// Stub function to fetch data (to be completed in the future)
...
// Stub function to populate the gradebook table (to be completed in the future)
function populateGradebook(data) {
  // This function will take the fetched grade data and populate the table
  console.log("Populating gradebook with data:", data);
  let tableElm = document.getElementById("gradebook"); // Get the gradebook table element
  data.forEach(assignment => { // For each row of data we're passed in
    ...
    columns.grade.appendChild(
      // We just put the name in text, you could be fancy and figure out the letter grade here
